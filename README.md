[![Build status](https://ci.appveyor.com/api/projects/status/eisbc3wjfjb1ttp7/branch/master?svg=true)](https://ci.appveyor.com/project/nagraiv/ts/branch/master)

# Домашнее задание к лекции «TypeScript» [ссылка](https://github.com/netology-code/ajs-homeworks/tree/master/typescript).

**Важно**: все задачи допустимо выполнять в одном GitHub репозитории.

**Важно**: тесты должны обеспечивать 100% покрытие тестируемых функций по строкам.

**Важно**: вы можете использовать преднастроенный [шаблон](https://github.com/netology-code/ajs-homeworks/tree/master/ts-template).
...
Реализуйте класс `Movie`, который позволяет отобразить информацию, указанную на сайте КиноПоиск
